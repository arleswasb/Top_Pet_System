...
class ProntuarioViewSet(viewsets.ModelViewSet):
    ...
    **Permissões:**
    ...
    def get_queryset(self):
        ...
        if profile.role in [Profile.Role.ADMIN, Profile.Role.VETERINARIO, Profile.Role.FUNCIONARIO] or user.is_staff:
            # Admins, veterinários e funcionários veem todos os prontuários
