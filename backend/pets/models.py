...
class Pet(models.Model):
    ...
    )  # Mantido como CharField por simplicidade inicial
    ...
    data_de_nascimento = models.DateField(
        ...
        ],  # Validador para não permitir datas futuras
    )

    sexo = models.CharField(
        max_length=15, choices=Gender.choices, default=Gender.UNKNOWN, verbose_name="Sexo"
    )
    ...
    tutor = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="pets", verbose_name="Tutor"
    )
    ...
    class Meta:
        indexes = [
            ...
            ),  # Adicionado índice para espécie
            models.Index(
                fields=["raca"], name="pet_raca_idx"
            ),  # Adicionado índice para raça
        ]
        verbose_name = "Pet"
