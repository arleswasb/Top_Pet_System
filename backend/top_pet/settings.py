"""Django settings for top_pet project."""
...
ALLOWED_HOSTS = ["*"]  # Permite conexões de qualquer host (para desenvolvimento)
...
DATABASES = {
    "default": {
        ...
        "HOST": os.environ.get("POSTGRES_HOST"),  # Lê o nome do host (db)
        "PORT": "5432",
    }
}
